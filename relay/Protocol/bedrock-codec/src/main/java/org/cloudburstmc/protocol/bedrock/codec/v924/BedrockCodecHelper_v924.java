...
public class BedrockCodecHelper_v924 extends BedrockCodecHelper_v898 {
    ...
    public void writeGatheringsConfiguration(ByteBuf buf, BedrockCodecHelper h, GatheringsConfigurationJoinInfo info) {
        h.writeUuid(buf, info.getExperienceId()); h.writeString(buf, info.getExperienceName());
        h.writeUuid(buf, info.getWorldId()); h.writeString(buf, info.getWorldName());
        h.writeString(buf, info.getCreatorId()); h.writeUuid(buf, info.getTargetId());
        h.writeString(buf, info.getScenarioId()); h.writeString(buf, info.getServerId());
    }
    @Override
