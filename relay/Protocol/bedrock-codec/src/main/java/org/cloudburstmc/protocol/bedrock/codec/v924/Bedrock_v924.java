...
public class Bedrock_v924 extends Bedrock_v898 {
    protected static final EntityDataTypeMap ENTITY_DATA = Bedrock_v898.ENTITY_DATA.toBuilder()
            ...
            .insert(EntityDataTypes.AIM_ASSIST_PRIORITY_ACTOR_ID, 138, EntityDataFormat.INT).build();
    protected static final TypeMap<SoundEvent> SOUND_EVENTS = Bedrock_v898.SOUND_EVENTS.toBuilder()
            .replace(578, SoundEvent.SADDLE_IN_WATER).insert(579, SoundEvent.STONE_SPEAR_ATTACK_HIT)
            .insert(580, SoundEvent.IRON_SPEAR_ATTACK_HIT).insert(581, SoundEvent.COPPER_SPEAR_ATTACK_HIT)
            .insert(582, SoundEvent.GOLDEN_SPEAR_ATTACK_HIT).insert(583, SoundEvent.DIAMOND_SPEAR_ATTACK_HIT)
            .insert(584, SoundEvent.NETHERITE_SPEAR_ATTACK_HIT).insert(585, SoundEvent.STONE_SPEAR_ATTACK_MISS)
            .insert(586, SoundEvent.IRON_SPEAR_ATTACK_MISS).insert(587, SoundEvent.COPPER_SPEAR_ATTACK_MISS)
            .insert(588, SoundEvent.GOLDEN_SPEAR_ATTACK_MISS).insert(589, SoundEvent.DIAMOND_SPEAR_ATTACK_MISS)
            .insert(590, SoundEvent.NETHERITE_SPEAR_ATTACK_MISS).insert(591, SoundEvent.STONE_SPEAR_USE)
            .insert(592, SoundEvent.IRON_SPEAR_USE).insert(593, SoundEvent.COPPER_SPEAR_USE)
            .insert(594, SoundEvent.GOLDEN_SPEAR_USE).insert(595, SoundEvent.DIAMOND_SPEAR_USE)
            .insert(596, SoundEvent.NETHERITE_SPEAR_USE).insert(597, SoundEvent.UNDEFINED).build();
    public static final BedrockCodec CODEC = Bedrock_v898.CODEC.toBuilder().protocolVersion(924).minecraftVersion("1.26.0")
            ...
            .registerPacket(CameraAimAssistActorPriorityPacket::new, CameraAimAssistActorPrioritySerializer_v924.INSTANCE, 339, PacketRecipient.CLIENT).build();
}
