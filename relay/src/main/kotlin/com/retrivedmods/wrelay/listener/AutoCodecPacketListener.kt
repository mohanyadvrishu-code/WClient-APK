...
import com.retrivedmods.wrelay.codec.VersionDetector
...
class AutoCodecPacketListener(
    ...
    // The old v729 inventory serializers are not wire-compatible with newer
    // codecs. Keep the escape hatch for experiments, but never enable it by
    // default for a current protocol.
    val patchCodec: Boolean = false
